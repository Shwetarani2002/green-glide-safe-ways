  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "EcoRide has completely changed my daily commute. The women drivers make me feel safe, and the electric vehicles are so smooth and quiet. Highly recommended!",
      avatar: "PS",
    },
    {
      name: "Rajesh Kumar",
      role: "Business Owner",
      rating: 5,
      text: "The monthly package is perfect for my business trips. Professional drivers, always on time, and the real-time tracking gives me peace of mind. Worth every rupee!",
      avatar: "RK",
    },
    {
      name: "Anjali Verma",
      role: "Student",
      rating: 5,
      text: "As a student who travels late evenings, the safety features like SOS button and ride sharing give me and my parents confidence. The eco-friendly aspect is a bonus!",
      avatar: "AV",
    },
    {
      name: "Vikram Singh",
      ...
      rating: 5,
      text: "Used EcoRide for an outstation trip to Agra. The driver was courteous, the car was spotless, and we had a comfortable journey. Will definitely use again!",
      avatar: "VS",
    },
    {
      name: "Meera Patel",
      ...
      rating: 5,
      text: "The 6-month plan with family sharing is fantastic! My whole family uses it, and the savings are incredible. Plus, contributing to a cleaner environment feels great.",
      avatar: "MP",
    },
  ];
